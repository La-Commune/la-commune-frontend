    ...
    >
      ...
      >
        ...
        >
          ...
          <textarea className={`${inputCls} resize-none`} rows={2} placeholder="Descripción" value={description} onChange={(e) => setDescription(e.target.value)} onFocus={scrollIntoCenter} />

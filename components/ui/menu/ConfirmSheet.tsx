  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-sm bg-white dark:bg-neutral-900 border-t sm:border border-stone-200 dark:border-stone-800 rounded-t-3xl sm:rounded-3xl px-6 pb-10 sm:pb-6 pt-5 space-y-5"
      ...
      >
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={onCancel}
            className="flex-1 py-5 rounded-2xl border border-stone-200 dark:border-stone-800 text-stone-500 text-[11px] uppercase tracking-[0.3em] hover:text-stone-600 dark:hover:text-stone-300 transition-colors"
          >
            Cancelar
          </button>
        </div>
